...
describe('ModuleContent against the modules that exist', () => {
  it('finds all 550 — ELEVEN complete five-level ladders, en-sa the last to close (#627, #653)', () => {
    expect(MODULE_FILES.map(([file]) => file)).toEqual([
      ...
      'content/en-sa/modules/L1-M10.json',
      'content/en-sa/modules/L1-M2.json',
      'content/en-sa/modules/L1-M3.json',
      'content/en-sa/modules/L1-M4.json',
      'content/en-sa/modules/L1-M5.json',
      'content/en-sa/modules/L1-M6.json',
      'content/en-sa/modules/L1-M7.json',
      'content/en-sa/modules/L1-M8.json',
      'content/en-sa/modules/L1-M9.json',
      'content/en-sa/modules/L2-M1.json',
      'content/en-sa/modules/L2-M10.json',
      'content/en-sa/modules/L2-M2.json',
      'content/en-sa/modules/L2-M3.json',
      'content/en-sa/modules/L2-M4.json',
      'content/en-sa/modules/L2-M5.json',
      'content/en-sa/modules/L2-M6.json',
      'content/en-sa/modules/L2-M7.json',
      'content/en-sa/modules/L2-M8.json',
      'content/en-sa/modules/L2-M9.json',
      'content/en-sa/modules/L3-M1.json',
      'content/en-sa/modules/L3-M10.json',
      'content/en-sa/modules/L3-M2.json',
      'content/en-sa/modules/L3-M3.json',
      'content/en-sa/modules/L3-M4.json',
      'content/en-sa/modules/L3-M5.json',
      'content/en-sa/modules/L3-M6.json',
      'content/en-sa/modules/L3-M7.json',
      'content/en-sa/modules/L3-M8.json',
      'content/en-sa/modules/L3-M9.json',
      'content/en-sa/modules/L4-M1.json',
      'content/en-sa/modules/L4-M10.json',
      'content/en-sa/modules/L4-M2.json',
      'content/en-sa/modules/L4-M3.json',
      'content/en-sa/modules/L4-M4.json',
      'content/en-sa/modules/L4-M5.json',
      'content/en-sa/modules/L4-M6.json',
      'content/en-sa/modules/L4-M7.json',
      'content/en-sa/modules/L4-M8.json',
      'content/en-sa/modules/L4-M9.json',
      'content/en-sa/modules/L5-M1.json',
      'content/en-sa/modules/L5-M10.json',
      'content/en-sa/modules/L5-M2.json',
      'content/en-sa/modules/L5-M3.json',
      'content/en-sa/modules/L5-M4.json',
      'content/en-sa/modules/L5-M5.json',
      'content/en-sa/modules/L5-M6.json',
      'content/en-sa/modules/L5-M7.json',
      'content/en-sa/modules/L5-M8.json',
      'content/en-sa/modules/L5-M9.json',
