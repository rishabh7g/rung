  ...
  'en-ar': {
    ...
    'L3-M1': {
      ...
      notes: [
        ...
        "INDEX SEAM: nawm, futūr, dhahāb, wuṣūl, dāʾiman, ʿādatan, nādiran, abadan, awwalan, akhīran and baʿda dhālika are fresh keys, the last indexed WHOLE so the bare dhālika is not spent on a phrase. baʿda and qabla are fresh single keys and each takes a following noun in the genitive — say so once, since L2 never needed the case. ʿamal, yawm and aḥyānan stay L1-M4's; thumma, lākin and ayḍan stay L1-M10's.",
      ],
      maxWordsPerSentence: 10,
      newWordCap: NEW_WORD_CAP,
    },
    'L3-M2': {
      ...
      notes: [
        ...
        "INDEX SEAM: sharika, mudīr, muwaẓẓaf, rātib, ijtimāʿ, jāmiʿa, imtiḥān, shahāda, yajibu, yumkinu and an are fresh keys. Every iḍāfa is written as TWO whitespace tokens and each token indexes on its own, so mudīr and ash-sharika are separate keys and the hyphen-part rule gives ash and sharika theirs as well — check the emitted index rather than assuming, per docs/54 §4. ʿamal stays L1-M4's, and the maṣdar rows stay M1's.",
      ],
      maxWordsPerSentence: 10,
      newWordCap: NEW_WORD_CAP,
    },
  ...
  'hi-en': {
    ...
    'L3-M2': {
      ...
      notes: [
        ...
        "INDEX SEAM: information, advice, equipment, furniture, luggage, homework, news, colleague, manager, salary, meeting, deadline, degree, apply, made and a piece of are fresh keys, the last indexed WHOLE as the three-token span the course already uses for a lot of. work is L1-M4's row doing its noun job here — point back and write the uncountable rule around it rather than opening a second. an is L1's; made points back at L2's make.",
      ],
      maxWordsPerSentence: 10,
      newWordCap: NEW_WORD_CAP,
    },
  ...
  'en-ru': {
    ...
    'L3-M1': {
      ...
      notes: [
        ...
        "INDEX SEAM: prosypáyus', umyváyus', odeváyus', vozvrashcháyus', obýchno, inogdá, redko, chásto, nikogdá, zatém, nakonéts and kázhdyy are fresh keys, each reflexive form its own single-token key with its note pointing back at the bare verb's row where the course owns one. nrávitsya stays L1-M9's; vsegdá stays L1-M4's; potóm stays L1-M10's; snachála stays L2-M10's.",
      ],
      maxWordsPerSentence: 10,
      newWordCap: NEW_WORD_CAP,
    },
    'L3-M2': {
      ...
      notes: [
        ...
        "INDEX SEAM: every instrumental form is its own single-token key (inzhenérom, vrachóm, drúgom, kollégoy, spórtom), each pointing back at the nominative's row, and NO L1 or L2 file is edited to accommodate it — docs/56 §4, unchanged. s, so, zanimáyus', kollega, nachál'nik, zarpláta, soveshchániye, universitét and ekzámen are fresh. rabóta and rabótayu stay L1's; vrach stays L2-M8's and this module adds only its instrumental cell.",
      ],
      maxWordsPerSentence: 10,
      newWordCap: NEW_WORD_CAP,
    },
  ...
  'en-it': {
    ...
    'L3-M1': {
      ...
      notes: [
        ...
        "INDEX SEAM: alzarsi cells (mi alzo, si alza), mi lavo, mi vesto, mi sveglio, mi riposo, di solito, spesso, qualche volta, raramente, mai, infine and ogni are fresh keys, with di solito and qualche volta indexed WHOLE so bare solito and volta are not spent. mi and ti stay L2-M5's rows; sempre stays L2-M4's; prima, dopo and poi stay where they were first taught.",
      ],
      maxWordsPerSentence: 10,
      newWordCap: NEW_WORD_CAP,
    },
    'L3-M2': {
      ...
      notes: [
        ...
        "INDEX SEAM: devo, posso, voglio, dobbiamo, per, ufficio, collega, capo, stipendio, riunione, ditta, laurea, esame and all'università are fresh keys, the last with its elision inside it. vorrei stays L1-M3's frozen row and devo's note says how a real modal differs from it; lavoro and studio stay L1-M4's rows, doing their noun jobs here with the notes pointing back.",
      ],
      maxWordsPerSentence: 10,
      newWordCap: NEW_WORD_CAP,
    },
  ...
  'en-fr': {
    ...
    'L3-M2': {
      ...
      notes: [
        ...
        "INDEX SEAM: chez, dois, peux, veux, bureau, collègue, patron, salaire, réunion, entreprise, études, examen and licence are fresh keys. je voudrais stays L2-M1's frozen row and dois's note says how a real modal differs from it; il faut stays L2-M4's whole surface; dans and à stay L1-M7's and L1-M4's rows; travail is fresh as a noun and points at L1-M4's travaille.",
      ],
      maxWordsPerSentence: 10,
      newWordCap: NEW_WORD_CAP,
    },
