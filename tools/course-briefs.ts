  ...
  'en-de': {
    ...
    'L3-M1': {
      ...
      notes: [
        ...
        "INDEX SEAM: einkaufen, anfangen, aufhören, fernsehen, abholen, mitkommen, aufstehen, los, zurück, meistens, oft, manchmal, selten, nie, normalerweise, täglich, Mittag, Nachmittag, Nacht and Woche are fresh keys, and so is every zu-infinitive the module writes (aufzustehen, einzukaufen, anzurufen) — each is one clean token and each takes its own row pointing back at its verb, because a level never edits a file below it. anrufen, einsteigen, aussteigen, ankommen, abfahren and Arbeit stay L2-M4's rows; stehe, stehen, aufgestanden, auf, um, Uhr, jeden, morgens and abends stay L1-M4's; ein stays L1-M1's; zu stays L1-M8's; fahre, fahren, kaufe, kaufen, mache and machen stay L1-M6's; zuerst, danach and schließlich stay L2-M10's; dann, also and immer stay L1-M10's.",
      ],
      maxWordsPerSentence: 10,
      newWordCap: NEW_WORD_CAP,
    },
  ...
  'en-ko': {
    ...
    'L3-M1': {
      ...
      notes: [
        ...
        "INDEX SEAM: botong, hangsang, jaju, gakkeum, geoui, byeollo, jeonhyeo, ireonayo and any daily verb the ladder still lacks are fresh keys. -eun, -neun, -i and -ga stay L1-M1's rows and this module re-shows them at length without editing a file; meonjeo, daeum and geu daeum-e stay L2-M10's; geurigo and hajiman stay L1-M10's; achim, jeonyeok, oneul, maeil and ilccik stay L1-M4's; jal stays L1-M2's. Note that jeongmal and neomu are both still FREE at the end of L2 — checked against the emitted fold, not assumed — so a module that wants an intensifier may take one, and M6 will want neomu.",
      ],
      maxWordsPerSentence: 10,
      newWordCap: NEW_WORD_CAP,
    },
    ...
    'L3-M7': {
      ...
      notes: [
        ...
        "M2's modifier does everyday work here, which is the whole reason it was opened at M2: apeun de (the place that hurts), meokneun yak (the medicine I take), eoje meogeun yak. A learner who met the modifier as an abstraction in M2 meets it as a useful phrase here, and the brief should say the two modules are one lesson in two parts. apeun is L2-M8's row already, so this module re-shows it rather than opening it.",
